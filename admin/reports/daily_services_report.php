...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">Informe de transacciones de servicio diario</h3>
	</div>
	<div class="card-body">
		<div class="container-fluid mb-3">
            <fieldset class="px-2 py-1 border">
                <legend class="w-auto px-3">Filtro</legend>
                <div class="container-fluid">
                    <form action="" id="filter-form">
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <button class="btn btn-dark btn-sm bg-gradient-dark rounded-0"><i class="fa fa-filter"></i> Filtro</button>
        ...
        <div class="container-fluid" id="printout">
			<table class="table table-hover table-striped table-bordered">
                ...
                <tfoot>
                    <th class="py-1 text-center" colspan="6">Costo total de mano de obra</th>
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-8 text-center">
            <div style="line-height:1em">
                ...
                <h3 class="text-center mb-0"><b>Informe de transacciones de servicio diario</b></h3>
