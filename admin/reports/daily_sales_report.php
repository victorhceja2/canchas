...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">Informe de ventas diarias</h3>
	</div>
	<div class="card-body">
                ...
                <div class="container-fluid">
                    <form action="" id="filter-form">
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <button class="btn btn-dark btn-sm bg-gradient-dark rounded-0"><i class="fa fa-filter"></i> Filter</button>
        ...
        <div class="container-fluid" id="printout">
			<table class="table table-hover table-striped table-bordered">
                ...
                <tfoot>
                    <th class="py-1 text-center" colspan="6">Venta Total</th>
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-8 text-center">
            <div style="line-height:1em">
                ...
                <h3 class="text-center mb-0"><b>Informe de ventas diarias</b></h3>
