...
<div class="mx-0 py-5 px-3 mx-ns-4 bg-gradient-dark">
	<h3><b><?= isset($id) ? "Actualizar Detalle de Venta" : "Crear Nueva Venta" ?></b></h3>
</div>
	...
	<div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
					...
					<form action="" id="sales-form">
						...
						<div class="row">
							<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
								<label for="client_name" class="control-label">Nombre Cliente</label>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-dark btn-sm bg-gradient-dark rounded-0" form="sales-form"><i class="fa fa-save"></i> Guardar</button>
				<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?page=sales"><i class="fa fa-angle-left"></i> Cancelar</a>
			</div>
		</div>
	</div>
</div>
