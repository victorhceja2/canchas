...
<div class="mx-0 py-5 px-3 mx-ns-4 bg-gradient-dark">
	<h3><b>Detalles de la transaccion</b></h3>
</div>
	...
	<div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-sm-12">
							<label for="control-label">Nombre Cliente</label>
			...
			<div class="card-footer py-1 text-center">
				<a class="btn btn-dark btn-sm bg-gradient-dark rounded-0" href="./?page=sales/manage_sale&id=<?= isset($id) ? $id : '' ?>"><i class="fa fa-edit"></i> Editar</a>
				...
				<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?page=sales"><i class="fa fa-angle-left"></i> Regresar a listado</a>
			</div>
		</div>
	</div>
</div>
...
<script>
	$(document).ready(function(){
        $('#delete-data').click(function(){
			_conf("Seguro de Elimnar esta Venta?","delete_sales",['<?= isset($id) ? $id : '' ?>'])
		})
	})
