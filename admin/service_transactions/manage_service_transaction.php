...
<div class="mx-0 py-5 px-3 mx-ns-4 bg-gradient-dark">
	<h3><b><?= isset($id) ? "Actualizar Detalles de transaccion de Servicios" : "Crear Transaccion de Servicios" ?></b></h3>
</div>
	...
	<div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
						...
						<fieldset>
							...
							<div class="row align-items-end mb-2">
								...
								<div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<button class="btn btn-dark bg-gradient-dark btn-sm rounded-0" type="button" id="add_service"><i class="fa fa-plus"></i> Add</button>
								</div>
							</div>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-dark btn-sm bg-gradient-dark rounded-0" form="service_transactions-form"><i class="fa fa-save"></i> Save</button>
