...
<div class="mx-0 py-5 px-3 mx-ns-4 bg-gradient-dark">
	<h3><b>Detalles de transacciones de Servicios</b></h3>
</div>
	...
	<div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
			...
			<div class="card-footer py-1 text-center">
				<a class="btn btn-info btn-sm bg-gradient-info rounded-0" href="javascript:void(0)" id="update_status"> Actualizar Status</a>
				<a class="btn btn-dark btn-sm bg-gradient-dark rounded-0" href="./?page=service_transactions/manage_service_transaction&id=<?= isset($id) ? $id : '' ?>"><i class="fa fa-edit"></i> Edit</a>
				<button class="btn btn-danger btn-sm bg-gradient-danger rounded-0" type="button" id="delete-data"><i class="fa fa-trash"></i> Eliminar</button>
				<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?page=service_transactions"><i class="fa fa-angle-left"></i> Regresar al listado</a>
			</div>
		</div>
	</div>
</div>
