...
<div class="card card-outline rounded-0 card-navy">
		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					...
					<small><i>Dejar en Blanco si no va a cambiar el password.</i></small>
                    <?php endif; ?>
				</div>
                <div class="form-group">
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-dark rounded-0 mr-3" form="manage-user">Guardar detalle de usuarios</button>
