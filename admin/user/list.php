...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=user/manage_user" id="create_new" class="btn btn-flat btn-dark"><span class="fas fa-plus"></span>  Crear Nuevo</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Esta seguro de eliminar el usuario?","delete_user",[$(this).attr('data-id')])
		})
		$('.table').dataTable({
			columnDefs: [
