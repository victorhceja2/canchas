...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">Lista de alquiler de canchas</h3>
		<div class="card-tools">
			<a href="./?page=court_rentals/manage_court_rental" class="btn btn-dark bg-gradient-dark btn-flat btn-sm"><i class="fa fa-plus"></i> Crear Nuevo</a>
		</div>
	</div>
	<div class="card-body">
							...
							<td align="center">
								 <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item view_data" href="./?page=court_rentals/view_court_rental&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> Ver</a>
