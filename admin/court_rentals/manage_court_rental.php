...
<div class="mx-0 py-5 px-3 mx-ns-4 bg-gradient-dark">
	<h3><b><?= isset($id) ? "Actualizar Detalles de Alquiler" : "Crear Nuevo Alquiler" ?></b></h3>
</div>
	...
	<div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
		<div class="card rounded-0 shadow">
						...
						<form action="" id="court_rental-form">
							...
							<div class="row">
								<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
									<label for="client_name" class="control-label">Nombre de Cliente</label>
							...
							<div class="row">
								<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
									<label for="court_id" class="control-label">Cancha</label>
								...
								<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
									<label for="court_price" class="control-label">Tarifa por Hora</label>
							...
							<div class="row">
								...
								<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
									<label for="hours" class="control-label">Horas</label>
							...
							<div class="row">
									...
									<fieldset>
										...
										<div class="row align-items-end mb-2">
											<div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
												<label for="product" class="control-label">Escoge Producto</label>
											...
											<div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
												<button class="btn btn-dark bg-gradient-dark btn-sm rounded-0" type="button" id="add_product"><i class="fa fa-plus"></i> Añadir</button>
											</div>
										</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<fieldset>
										...
										<div class="row align-items-end mb-2">
											<div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
												<label for="service" class="control-label">Escoge servicio</label>
											...
											<div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
												<button class="btn btn-dark bg-gradient-dark btn-sm rounded-0" type="button" id="add_service"><i class="fa fa-plus"></i> Añadir</button>
											</div>
										</div>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-dark btn-sm bg-gradient-dark rounded-0" form="court_rental-form"><i class="fa fa-save"></i> Guardar</button>
				<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?page=court_rentals"><i class="fa fa-angle-left"></i> Cancelar</a>
			</div>
		</div>
	</div>
</div>
...
<script>
	...
	$(document).ready(function(){
		$('#court_id').select2({
			placeholder:"Seleccione Cancha aqui",
			width:"100%",
			containerCssClass:'form-control form-control-sm rounded-0'
		})
		$('#product').select2({
			placeholder:"Seleccione Producto aqui",
			width:"100%",
			containerCssClass:'form-control form-control-sm rounded-0'
		})
		$('#service').select2({
			placeholder:"Seleccione Servicio aqui",
			width:"100%",
			containerCssClass:'form-control form-control-sm rounded-0'
		})
