		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile1">Escoger Archivo</label>
	            </div>
			</div>
			...
			<div class="form-group">
				<label for="" class="control-label">Fondo de Web</label>
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile2" name="cover" onchange="displayImg2(this,$(this))">
	              <label class="custom-file-label" for="customFile2">Escoger Archivo</label>
	            </div>
			</div>
			<div class="form-group d-flex justify-content-center">
